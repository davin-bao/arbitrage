...
from ...domain.models.open_intent import OpenIntent
...
from ...domain.value_objects.enums import ExecutionState, OrderType, TradeSide
...
class SimulatedExecutionService(ExecutionService):
    ...
    def close_position(
        ...
        return ExecutionResult(
            success=True,
            position=position,
            state=ExecutionState.OPENED  # 实际应用中这里应该是CLOSING或CLOSED状态
        )
